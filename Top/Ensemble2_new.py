...
if __name__ == "__main__":
   ...
   # parser.add_argument('--new_test_r9_Score', default='/home/zjl_laoshi/xiaoke/Top/Model_inference/Mix_GCN/output/B/ctrgcn_V1_J_3D/epoch1_test_score.pkl')
   # parser.add_argument('--new_test_r10_Score', default='/home/zjl_laoshi/xiaoke/Top/Model_inference/Mix_GCN/output/B/ctrgcn_V1_B_3D/epoch1_test_score.pkl')
    parser.add_argument('--new_test_r9_Score', default='/home/zjl_laoshi/xiaoke/Top/Model_inference/Mix_GCN/output/result/tdgcn_V1_J/epoch1_test_score.pkl')
    parser.add_argument('--new_test_r10_Score', default='/home/zjl_laoshi/xiaoke/Top/Model_inference/Mix_GCN/output/result/tdgcn_V1_B/epoch1_test_score.pkl')
    parser.add_argument('--new_test_r11_Score', default='/home/zjl_laoshi/xiaoke/Top/Model_inference/Mix_GCN/output/result/mstgcn_V1_J/epoch1_test_score.pkl')
    parser.add_argument('--new_test_r12_Score', default='/home/zjl_laoshi/xiaoke/Top/Model_inference/Mix_GCN/output/result/mstgcn_V1_B/epoch1_test_score.pkl')
    # parser.add_argument('--new_test_r13_Score', default='/home/zjl_laoshi/xiaoke/TE-GCN/work_dir/2995_B/epoch1_test_score.pkl')
    ...
    # accuracies = [0.7035, 0.6585, 0.2, 0.2, 0.2, 0.2, 0.7105, 0.704, 0.7155, 0.703, 0.701, 0.7, 0.7225]  # Example accuracies 75%
