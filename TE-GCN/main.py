...
class Processor():
    ...
    def eval(self, epoch, save_score=True, loader_name=['test'], wrong_file=None, result_file=None,pred_result_file=None):
        ...
        for ln in loader_name:
            ...
            if pred_result_file is not None:  
                np.save(pred_result_file, predictions)
    ...
    def start(self):
        if self.arg.phase == 'train':
            ...
            if not self.arg.test_feeder_args['debug']:
                ...
                pred_result_file = self.arg.model_saved_name + '_predictions.npy'
            else:
                wf = rf = None
            ...
            self.eval(epoch=0, save_score=self.arg.save_score, loader_name=['test'], wrong_file=wf, result_file=rf,pred_result_file=pred_result_file)
            self.print_log('Done.\n')
